...
let downloadUrl = 'https://lhcforms-static.nlm.nih.gov/lforms-versions';

const versionFile = JSON.parse(fs.readFileSync('src/assets/version.json'));
// Change version here to update LForms package.
const version = versionFile.lformsVersion;
