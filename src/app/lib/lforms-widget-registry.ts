...
import {SelectValueSetComponent} from './widgets/select-value-set/select-value-set.component';
import {BooleanRadioHiddenComponent} from './widgets/boolean-radio-hidden/boolean-radio-hidden.component';
import {InitialChoicesComponent} from './widgets/initial-choices/initial-choices.component';
import {BooleanRadioSubjectComponent} from './widgets/boolean-radio-subject/boolean-radio-subject.component';
import {ReferenceResourceComponent} from './widgets/reference-resource/reference-resource.component';
import {ExpressionComponent} from './widgets/expression/expression.component';
import {LaunchContextComponent} from './widgets/launch-context/launch-context.component';
import {DefinitionComponent} from './widgets/definition/definition.component';
import {UseContextComponent} from './widgets/use-context/use-context.component';
...
export class LformsWidgetRegistry extends DefaultWidgetRegistry {
  constructor() {
    ...
    this.register('select-value-set', SelectValueSetComponent);
    this.register('radio-hidden', BooleanRadioHiddenComponent);
    this.register('initial-choices', InitialChoicesComponent);
    this.register('radio-subject', BooleanRadioSubjectComponent);
    this.register('reference-select-field', ReferenceResourceComponent);
    this.register('expression', ExpressionComponent);
    this.register('launch-context', LaunchContextComponent);
    this.register('definition', DefinitionComponent);
    this.register('use-context', UseContextComponent);
